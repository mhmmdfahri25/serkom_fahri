...
<body>
  ...
  <div class="sidebar-wrapper" id="sidebar">
    ...
    <div class="flex-grow-1 overflow-y-auto">
      ...
      <!-- Group: Components -->
      <div class="sidebar-menu-section">
        <div class="sidebar-menu-title">Profile</div>
        <ul class="sidebar-menu-list">
          <li class="sidebar-menu-item">
            <a href="{{ route('admin.profile') }}" class="sidebar-menu-link" id="menu-basictables" title="Basic Tables">
      ...
      <div class="sidebar-menu-section">
        ...
        <ul class="sidebar-menu-list">
          <li class="sidebar-menu-item">
            <a href="{{ route('admin.berita') }}" class="sidebar-menu-link" id="menu-blankpage" title="Blank Page">
              <i class="bi bi-newspaper"></i>
              <span>Kelola Berita</span>
            </a>
          <li class="sidebar-menu-item">
            <a href="{{ route('admin.guru') }}" class="sidebar-menu-link" id="menu-blankpage" title="Blank Page">
              <i class="bi bi-person-badge"></i>
              <span>Kelola Guru</span>
            </a>
          </li>
          <li class="sidebar-menu-item">
            <a href="{{ route('admin.siswa') }}" class="sidebar-menu-link" id="menu-loginpage" title="Login Page">
          ...
          <li class="sidebar-menu-item">
            <a href="{{ route('admin.galeri') }}" class="sidebar-menu-link" id="menu-loginpage" title="Login Page">
